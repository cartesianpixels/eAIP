...
app.use(cors({
    origin: ['http://localhost:3001', 'http://localhost:3000', 'http://localhost:3002', 'https://eaip.vercel.app', /\.vercel\.app$/],
    credentials: true,
...
// For local testing, can still run this file directly if needed, but for Vercel exports are key
